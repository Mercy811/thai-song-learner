 ...
 *
 * 时间轴说明：
 *   下面的 start 是「估算值」，不是从原曲量出来的。
 *   打开网页 → 右上角「⏱ 校准时间轴」→ 跟着歌按空格，30 秒就能校准准确。
 *   校准结果自动存在浏览器里；点「导出」可以把数字贴回这个文件，分享给别人。
 */
