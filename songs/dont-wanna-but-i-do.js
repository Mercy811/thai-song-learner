...
(() => {
  ...
  const TIMES = {
    v1: [7.85, 10.55, 14.08, 18.13],   // 主歌
    p1: [23.62, 27.26, 31.09, 34.99],   // 预副歌
    c1: [39.63, 42.12, 47.14, 49.51],   // 副歌
    h1: [55.16, 58.89, 62.65, 66.43],   // 尾音
    v2: [70.08, 73.45],   // 过渡段
    p2: [78.33, 83.47, 87.88, 91.28],   // 预副歌
    c2: [95.86, 98.45, 103.51, 106.06],   // 副歌
    h2: [111.48, 115.12, 118.93, 122.63],   // 尾音
    c3: [126.12, 128.27, 133.65, 137.43],   // 副歌（连唱）
    c4: [141.26, 143.33, 145.19, 147.95],   // 副歌（连唱）
    h3: [154.65, 160.11, 163.93, 167.58],   // 尾音（终）
  };
