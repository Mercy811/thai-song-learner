 ...
 *
 * 时间轴说明：
 *   下面 TIMES 里全部 41 句的 start 都已在网页里跟着原曲逐句标记校准，单位是秒。
...
(() => {
  ...
  const TIMES = {
    v1: [3.76, 8.20, 11.62, 15.22],   // 主歌 A
    v2: [21.85, 25.54, 29.92, 33.71],   // 主歌 B
    c1: [38.78, 42.42, 47.16, 53.65, 56.95, 60.95, 64.72, 69.17, 73.55],   // 副歌
    v3: [78.55, 82.89, 87.43, 91.25],   // 主歌 C
    c2: [96.49, 100.26, 104.69, 111.29, 114.44, 118.78, 122.58, 127.21, 131.62],   // 副歌
    br: [136.46, 140.82],   // 过渡段
    c3: [148.59, 152.54, 155.67, 158.43, 162.05, 166.47, 169.87, 174.31, 177.00],   // 副歌（终）
  };
