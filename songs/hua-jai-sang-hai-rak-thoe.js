 ...
 *
 * 时间轴说明：
 *   下面 TIMES 里全部 48 句的 start 都已在网页里跟着原曲逐句标记校准，单位是秒。
...
(() => {
  ...
  const TIMES = {
    v1: [11.58, 15.81, 19.01, 24.24, 28.43, 31.75, 33.66, 38.05, 42.73],   // 主歌 A
    p1: [48.11, 52.17, 57.99, 60.91],   // 预副歌
    c1: [65.24, 70.39, 74.94, 77.43, 80.06, 83.56, 88.06, 96.05, 100.48],   // 副歌
    v2: [106.58, 110.23, 114.85, 119.27],   // 主歌 B
    p2: [125.39, 129.04, 132.80, 137.71],   // 预副歌
    c2: [141.52, 146.85, 151.52, 153.84, 156.34, 159.73, 164.69, 172.10, 176.75],   // 副歌
    c3: [195.85, 200.47, 205.07, 207.64, 210.11, 213.92, 218.58, 226.12, 231.26],   // 副歌（尾）
  };
